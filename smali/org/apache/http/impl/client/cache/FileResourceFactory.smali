...
.method public constructor <init>(Ljava/io/File;)V
    ...
    .line 53
    new-instance v0, Lorg/apache/http/impl/client/cache/BasicIdGenerator;

    invoke-direct {v0}, Lorg/apache/http/impl/client/cache/BasicIdGenerator;-><init>()V

    iput-object v0, p0, Lorg/apache/http/impl/client/cache/FileResourceFactory;->idgen:Lorg/apache/http/impl/client/cache/BasicIdGenerator;
...
.method private generateUniqueCacheFile(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object v4, p0, Lorg/apache/http/impl/client/cache/FileResourceFactory;->idgen:Lorg/apache/http/impl/client/cache/BasicIdGenerator;

    invoke-virtual {v4, v0}, Lorg/apache/http/impl/client/cache/BasicIdGenerator;->generate(Ljava/lang/StringBuilder;)V
    ...
    iget-object v5, p0, Lorg/apache/http/impl/client/cache/FileResourceFactory;->cacheDir:Ljava/io/File;
...
.method public copy(Ljava/lang/String;Lorg/apache/http/client/cache/Resource;)Lorg/apache/http/client/cache/Resource;
    ...
    instance-of v3, p2, Lorg/apache/http/impl/client/cache/FileResource;
    ...
    invoke-static {v2, v0}, Lorg/apache/http/impl/client/cache/IOUtils;->copyFile(Ljava/io/File;Ljava/io/File;)V

    .line 108
    .end local v2    # "src":Ljava/io/File;
    :goto_0
    new-instance v3, Lorg/apache/http/impl/client/cache/FileResource;

    invoke-direct {v3, v0}, Lorg/apache/http/impl/client/cache/FileResource;-><init>(Ljava/io/File;)V
    ...
    invoke-static {v3, v1}, Lorg/apache/http/impl/client/cache/IOUtils;->copyAndClose(Ljava/io/InputStream;Ljava/io/OutputStream;)V
...
.method public generate(Ljava/lang/String;Ljava/io/InputStream;Lorg/apache/http/client/cache/InputLimit;)Lorg/apache/http/client/cache/Resource;
    ...
    .line 93
    new-instance v6, Lorg/apache/http/impl/client/cache/FileResource;

    invoke-direct {v6, v1}, Lorg/apache/http/impl/client/cache/FileResource;-><init>(Ljava/io/File;)V
